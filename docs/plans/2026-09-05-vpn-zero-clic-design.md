...
secret. On the reference client that fails with RAS error 628 on `VPN Contoso`, while the Windows
...
Read-only probes against the real `VPN Contoso` profile, 2026-09-05. No secret was displayed, nothing
